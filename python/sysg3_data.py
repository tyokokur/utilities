...
# a1s25_mic (12.2, 20.2, 36.2), Josh
a1s25_mic.new((14.2, 20.2, 36.2), -1.45894, icm=8.2e-03, err=1.0e-03)
# a1s25_mic (16.2, 20.2, 36.2), Josh
# a1s25_mic (14.2, 22.6, 36.2), Josh
...
# a2s10_mic ( 8.2,  8.2, 54.2), Josh
a2s10_mic.new((10.2, 10.2, 54.2), -5.63481, icm=7.6e-03, err=7.0e-04)
# a2s10_mic (12.2, 12.2, 54.2), Josh
a2s10_mic.new((14.2, 22.2, 36.2), -5.63302, icm=2.0e-02, err=3.3e-03) # (14.2, 21.2, 54.2), Josh
a2s10_mic.new((16.2, 22.2, 36.2), -5.63101, icm=5.9e-02, err=4.8e-03) # (16.2, 21.2, 54.2), Josh
...
# a2s10_str (10.2, 20.2, 54.2), Josh
a2s10_str.new((12.2, 20.2, 36.2), -5.63511, icm=1.2e-03, err=2.5e-04) # (12.2, 20.2, 54.2), Josh
a2s10_str.new((14.2, 20.2, 36.2), -5.63358, icm=6.1e-02, err=3.1e-03) # (14.2, 20.2, 54.2), Josh
...
a2s15_mic.new((18.2, 20.2, 64.2), -8.44000, icm=1.0e-02, err=1.7e-03)
...
a25s20_pn = Data(0.25, 0.020, 'str')
a25s20_pn.new((11.0, 20.2, 64.2), -10.8757, icm=1.1e-02, err=2.3e-03)
a25s20_pn.new((12.2, 20.2, 64.2), -10.8766, icm=9.7e-03, err=2.1e-03)
a25s20_pn.new((13.0, 20.2, 64.2), -10.8764, icm=1.6e-02, err=3.5e-03)
a25s20_pn.done=True
...
a3s5_pn.new((11.0, 20.2, 96.2), -25.3647, icm=4.7e-03, err=3.0e-04)
