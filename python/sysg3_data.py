...
a05s6_hol.new((27.2, 20.2, 36.2), -3.57732, icm=1.1e-02, err=6.5e-04)
a05s6_hol.new((24.2, 20.2, 36.2), -3.57732, icm=8.6e-03, err=7.9e-04)
a05s6_hol.new((25.2, 19.2, 36.2), -3.57733, icm=7.0e-03, err=7.3e-04)
...
a2s15_mic.new((16.2, 20.2, 64.2), -8.43985, icm=8.6e-03, err=1.5e-03)
a2s15_mic.new((18.2, 18.2, 64.2), -8.43889, icm=4.6e-04, err=1.5e-03)
a2s15_mic.new((20.2, 18.2, 64.2), -8.43976, icm=9.4e-03, err=1.8e-03)
...
a225s275_pn.new((17.0, 20.2, 70.2), -15.1291, icm=6.9e-03, err=1.1e-03) 
