...
a2s15_mic.done = True
a2s15_mic.new((18.2, 16.2, 64.2), -8.43956, icm=1.2e-02, err=1.7e-03)
...
a225s275_mic.new((13.0, 13.0, 70.2), -15.1287, icm=2.7e-03, err=4.4e-04) 
...
a225s275_cyl.new((11.0, 11.0, 70.2), -15.1267, icm=2.5e-02, err=2.0e-03) 
...
a225s275_pn.new((11.0, 15.2, 70.2), -15.1269, icm=1.4e-02, err=1.8e-03) 
a225s275_pn.new((13.0, 15.2, 70.2), -15.1281, icm=1.3e-02, err=2.0e-03) 
...
a25s25_pn.new((11.0, 15.2, 70.2), -13.5448, icm=6.4e-03, err=1.2e-03)
a25s25_pn.new((13.0, 15.2, 70.2), -13.5451, icm=8.3e-03, err=1.9e-03)
...
a3s325_pn.new((12.2, 18.2, 80.2), -16.8494, icm=7.2e-03, err=9.8e-04) # n = 2
...
a3s5_mul.new((20.2, 20.2, 96.2), -25.3599, icm=2.4e-02, err=5.1e-03)
a3s5_mul.multi=True
