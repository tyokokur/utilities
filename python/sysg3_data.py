...
a25s15_cp.new((16.4, 13.0, 54.2), -8.18707, icm=2.2e-02, err=2.6e-03)
a25s15_cp.new((16.4, 14.6, 54.2), -8.18653, icm=1.5e-02, err=1.7e-03)
a25s15_cp.new((16.4, 16.4, 54.2), -8.18563, icm=2.0e-02, err=1.7e-03)
a25s15_cp.new((19.4, 13.0, 54.2), -8.18775, icm=3.3e-02, err=2.3e-03)
...
a25s45_str.new((14.6, 16.2, 81.2), -23.9207, icm=5.3e-03, err=9.0e-04)
datasets += pack_data('a25s4_hom', a25s4_hom)
