...
a1s75_hol.new((24.2, 26.2, 36.2), -4.42374, icm=5.5e-02, err=2.3e-03)
a1s75_hol.new((27.2, 29.2, 36.2), -4.42385, icm=6.5e-02, err=2.4e-03)
...
a2s2_str.new((24.2, 20.2, 64.2), -11.2340, icm=1.3e-02, err=2.9e-03)
...
a25s3_cyl.new((15.2, 17.6, 72.2), -16.1858, icm=8.0e-03, err=5.2e-04)
a25s3_cyl.new((15.2, 15.2, 72.2), -16.1858, icm=1.2e-02, err=8.1e-04)
a25s3_cyl.new((13.0, 15.2, 72.2), -16.1856, icm=1.4e-02, err=1.2e-03)
a25s3_cyl.new((17.6, 17.6, 72.2), -16.1857, icm=3.2e-03, err=3.4e-04)
a25s3_cyl.new((20.2, 17.6, 72.2), -16.1856, icm=5.7e-03, err=7.1e-04)
a25s3_cyl.done = True
...
a3s3_mic.new((13.0, 15.2, 70.2), -15.5833, icm=6.1e-02, err=8.2e-03)
a3s3_mic.new((15.2, 16.2, 70.2), -15.5827, icm=5.1e-02, err=8.5e-03)
a3s3_mic.multi=True
