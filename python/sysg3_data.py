...
a05s5_mic.new((21.8, 27.2, 36.2), -2.97379, icm=1.2e-02, err=2.9e-03)
a05s5_mic.new((25.2, 27.2, 36.2), -2.97282, icm=2.6e-02, err=4.0e-03)
...
a25s27_str.new((13.0, 15.2, 64.2), -14.6016, icm=1.1e-03, err=2.1e-04)
