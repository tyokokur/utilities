...
a15s25_mic.new((18.2, 16.4, 54.2), -1.43605, icm=8.3e-03, err=7.5e-04)
a15s25_mic.new((18.2, 21.8, 54.2), -1.43606, icm=7.5e-03, err=5.5e-04)
a15s25_mic.new((20.2, 20.2, 54.2), -1.43587, icm=2.1e-02, err=1.5e-03)
a15s25_mic.new((20.2, 25.2, 54.2), -1.43599, icm=7.7e-03, err=5.3e-04)
...
a2s025_mic.new((18.2, 16.4, 48.2), -1.41041, icm=1.2e-02, err=1.0e-03)
...
a25s15_str.new((12.2, 20.2, 54.2), -8.18861, icm=5.8e-03, err=1.3e-03)
...
a25s20_pn.new((12.2, 18.2, 64.2), -10.8773, icm=1.4e-02, err=1.0e-03)
...
a25s3_str.new((12.2, 16.2, 72.2), -16.1892, icm=1.6e-03, err=2.0e-04)
a25s3_str.done=True
