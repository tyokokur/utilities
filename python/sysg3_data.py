...
a1s25_mic.new((28.2, 25.8, 40.2), -1.45930)
a1s25_mic.done=True
...
a1s675_fus.new((21.2, 20.2, 40.2), -3.68177, icm=1.9e-03, err=3.9e-04)
...
''' alpha = 0.15, sigma = 0.002 '''
a15s20_mic = Data(0.15, 0.002, 'mic')
a15s20_mic.new((1,1,1), -0.5)
a15s20_mic.done=True
datasets+=pack_data('a15s20_mic', a15s20_mic)
...
a15s25_str.new((18.2, 20.2, 36.2), -1.43590, icm=1.5e-03, err=2.5e-04)
a15s25_str.done=True
datasets += pack_data('a15s25_str', a15s25_str)

a15s25_hol = Data(0.15, 0.0025, 'hol')
a15s25_hol.new((18.2, 21.8, 36.2), -1.43609, icm=2.5e-03, err=2.5e-04)
a15s25_hol.done=True
...
a15s375_mic.done=True
datasets += pack_data('a15s375_mic', a15s375_mic)

a15s375_str = Data(0.15, 0.00375, 'str')
a15s375_str.new((15.2, 20.2, 40.2), -2.16133, icm=5.4e-03, err=8.3e-04)
a15s375_str.new((17.2, 20.2, 40.2), -2.16126, icm=1.5e-03, err=1.9e-04)
a15s375_str.done=True
datasets += pack_data('a15s375_str', a15s375_str)

a15s375_hol = Data(0.15, 0.00375, 'hol')
a15s375_hol.new((24.2, 27.2, 40.2), -2.16076, icm=7.9e-03, err=5.2e-04)
a15s375_hol.new((25.2, 28.2, 40.2), -2.16077, icm=9.7e-03, err=5.2e-04)
a15s375_hol.new((28.2, 29.2, 40.2), -2.16065, icm=1.2e-02, err=9.4e-04)
a15s375_hol.done=True
datasets += pack_data('a15s375_hol', a15s375_hol)
...
''' alpha = 0.15, sigma = 0.0125 '''
a15s125_fus = Data(0.15, 0.0125, 'fus')
a15s125_fus.new((1,1,1), -0.5)
a15s125_fus.done=True
datasets += pack_data('a15s125_fus', a15s125_fus)
...
''' alpha = 0.15, sigma = 0.0175 '''
a15s175_hom = Data(0.15, 0.0175, 'hom')
a15s175_hom.new((1,1,1), -0.5)
a15s175_hom.done=True
datasets += pack_data('a15s175_hom', a15s175_hom)
...
datasets += pack_data('a2s375_mic', a2s375_mic)

a2s375_str = Data(0.20, 0.00375, 'str')
a2s375_str.new((15.2, 20.2, 48.2), -2.11697, icm=1.2e-03, err=1.8e-04)
...
a25s25e3_cyl.new((21.2, 18.2, 48.2), -1.38217, icm=1.3e-02, err=9.4e-04)
a25s25e3_cyl.new((22.6, 19.8, 48.2), -1.38249, icm=1.4e-02, err=1.3e-03)
a25s25e3_cyl.new((24.2, 21.2, 48.2), -1.38254, icm=1.8e-02, err=1.3e-03)
datasets += pack_data('a25s25e3_cyl', a25s25e3_cyl)

a25s25e3_mic = Data(0.25, 0.0025, 'mic')
a25s25e3_mic.new((21.2, 18.2, 48.2), -1.38213, icm=9.0e-03, err=6.1e-04)
...
# a25s05_cp = Data(0.25, 0.005, 'cyl-pn')
a25s05_cp = Data(0.25, 0.005, 'cyl-str')
...
a25s10_cp.new((21.2, 12.2, 54.2), -5.48466, icm=5.7e-03, err=4.5e-04)
a25s10_cp.done=True
...
a3s1_cyl.new(( 9.2,  9.2, 64.2), -5.32837, icm=1.3e-02, err=1.3e-03)
a3s1_cyl.new((10.2, 10.2, 64.2), -5.32988, icm=9.4e-03, err=6.9e-04)
a3s1_cyl.new((11.0, 11.0, 64.2), -5.33108, icm=1.1e-02, err=9.2e-04)
a3s1_cyl.new((12.2, 12.2, 64.2), -5.33070, icm=7.9e-03, err=1.5e-03)
a3s1_cyl.done=True
datasets += pack_data('a3s1_cyl', a3s1_cyl)
...
a3s15_cyl.new((12.2, 12.2, 70.2), -7.93235, icm=4.8e-03, err=1.0e-03)
a3s15_cyl.done=True
datasets += pack_data('a3s15_cyl', a3s15_cyl)

a3s15_cp = Data(0.30, 0.015, 'cyl-pn')
a3s15_cp.new((21.2, 11.0, 64.2), -7.93490, icm=2.7e-02, err=2.1e-03)
a3s15_cp.new((24.2,  9.2, 64.2), -7.93234, icm=1.2e-02, err=2.5e-03)
...
a3s25_cp = Data(0.30, 0.025, 'cyl-pn')
a3s25_cp.new((27.2, 11.0, 72.2), -13.0676, icm=1.9e-02, err=1.9e-03)
a3s25_cp.new((27.2, 12.2, 72.2), -13.0663, icm=2.2e-02, err=2.5e-03)
a3s25_cp.new((30.2, 12.2, 72.2), -13.0663, icm=2.1e-02, err=2.6e-03)
a3s25_cp.done = True
datasets += pack_data('a3s25_cp', a3s25_cp)
...
a3s4_pn.new((10.2, 20.2, 86.6), -20.5592, icm=2.4e-03, err=1.6e-04)
a3s4_pn.new((10.2, 21.2, 86.6), -20.5593, icm=2.8e-03, err=2.1e-04)
